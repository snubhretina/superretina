...
def init_experiment(args, model_name):
    ...
    if cfg.resume_exp:
        ...
        if cfg.exp_name:
            exp_name += '_' + cfg.exp_name + '_' + cfg.dataset_name
        if cfg.use_trimap == False:
            exp_name += '_' + "without_trimap"
        # exp_name += '_' + "1024_0.5_0.6_scale_"
        # exp_name += '_' + "refine_ssa_focus_1024_radius_{}".format(cfg.radius)
